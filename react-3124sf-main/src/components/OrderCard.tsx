...
import { Order, deleteOrder } from "../api/order";
...
export default function OrderCard( {order} : any) {
    ...
    const onEditClick = async () => {
        try {
            window.location.href = `/orders/form?id=${order.id}`;
          } catch (error) {
            console.error("Error fetching orders:", error);
          }
    }
    ...
    return (
        <div className="my-2">
            <div className="w-60 h-56 bg-white rounded-3xl drop-shadow-lg mx-2">
                ...
                <div className="mt-3 px-4">
                    ...
                    <p className="text-xs">
                        Order Date : {dayjs(order.order_date).format('dddd hh:mm A, MMMM YYYY. ')}
                    </p>
                    <p className="text-xs">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="px-1.5 mr-1.5 text-xs font-light">Total Price : {order.total_price}
                        </span>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        <div>
